  ...
  const projects = [
    {
      ...
      description: 'A simple rock-paper-scissors game with a modern UI and animations.',
      technologies: ['React'],
      image: 'project1.png',
      link: 'https://rps-woad-pi.vercel.app/',
      github: 'https://github.com/kumsquare/rps',
    },
    {
      title: 'Student registeration form',
        description: 'A student registration form with validation and responsive design.',
      technologies: ['React'],
      image: 'project2.jpg',
      link: 'https://register-eosin.vercel.app/',
      github: 'https://github.com/kumsquare/register',
    },
    {
      title: 'Number game',
        description: 'A number guessing game with a specific number of chances.',
      technologies: ['React'],
      image: 'project3.jpg',
      link: 'https://number-game-three-pi.vercel.app/',
      github: 'https://github.com/kumsquare/numberGame',
    },
    {
      title: 'Pizza Billing',
      description: 'A pizza billing system with a user-friendly interface and order management.',
      technologies: ['React'],
      image: 'project4.jpg',
      link: 'https://pizza-billing-two.vercel.app/',
      github: 'https://github.com/kumsquare/pizzaBilling',
    },
  ];
