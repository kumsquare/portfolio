    ...
    <section id="home" className="pt-32 pb-20 md:pt-40 md:pb-28">
      <div className="grid md:grid-cols-2 gap-8 items-center relative">
        ...
        <div className="flex justify-center items-center relative">
          {/* You can add an image later if you want */}
          <div
            ref={imageRef}
            className="w-64 h-64 bg-gray-200 dark:bg-gray-700 rounded-full transition-all duration-700 delay-300 transform opacity-0 translate-x-5"
          >
            {/* Image or Illustration can go here */}
          </div>

          {/* Social Links Positioned Absolutely */}
          <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 flex space-x-4 bg-white dark:bg-gray-800 py-2 px-6 rounded-full shadow-lg">
